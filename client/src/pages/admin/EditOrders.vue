<template>
  <div class="EditOrders">
    ...
    <div class="content">
      ...
      <div class="inputBox">
        <span>规格：</span>
        <Radio v-for="item in spec" :key="item.id" v-model="temSpecId" :initVal="temSpecId" radioName="spec" :radioVal="item.id">
      ...
      <div class="inputBox">
        <span>订单状态：</span>
        <Radio v-for="item in states" :key="item.id" v-model="temStateId" :initVal="temStateId" radioName="state" :radioVal="item.id">
