  ...
  <div class="MallIndex">
    ...
    <section class="hotGoods section">
      ...
      <div class="content">
        <ul class="left">
          <GoodsItem 
            v-for="(item,index) in goodsList.slice(0,1)"
        ...
        <ul class="right">
           <GoodsItem 
            v-for="(item,index) in goodsList.slice(1,7)"
            :style="{marginBottom: index<=2?'10px':'0px'}"
            :key="+item.id"
            :id="item.id"
            :img="item.img"
    ...
    <section class="typeSection section" v-for="item in typeList.slice(1)" :key="item.id">
